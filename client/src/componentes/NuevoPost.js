...
export default function NuevoPost() {
    ...
    const [post, setPost] = useState({imagen:'', titulo:'', contenido:''})
                ...
                <Modal.Body>
                    <div className="row">
                        ...
                        <div >
                            ...
                            <textarea type="email" className="form-control" name='contenido'  rows="10"  value={post.contenido} onChange={ handleChange}/>
